...
class ShoufuChatPage extends GetView<ShoufuChatController> {
  ...
  Widget leftbubble(ChatMessage message, int index,
            ...
            Container(
              ...
              child: message.replyList == null
                  ...
                  : SingleChildScrollView(
                      child: Container(
                        child: buildPanel(message.replyList!),
                      ),
                    ),
            ),
          ],
  ...
  Widget buildPanel(List<ReplyMessage> replies) {
